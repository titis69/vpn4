...
sleep 2
clear
wget https://raw.githubusercontent.com/titis69/VPN6/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
...
wget https://raw.githubusercontent.com/titis69/VPN6/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
